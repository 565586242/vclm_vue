<template>
  <div>
		<main-nav :title="$t('title.flowRecharge')" fontColor="#fff" bgColor="#2C303E" :backShow="true" borderBottom="#252935"></main-nav>
    <div class="phone-div">
      <img src="~assets/img/ecology/app/icon_yonghu@2x.png" mode />
      <div class="phone-input">
        <input type="text" :placeholder="$t('ecology.placeholder_phone')" v-model="formData.card_num" />
      </div>
      <!-- <div class="phone-adress">{{phoneAdress}}</div> -->
      <div class="phone-sizes">
        <div @click="moneyClick(100)">
          <div class="size-title">100MB</div>
        </div>
        <div @click="moneyClick(200)">
          <div class="size-title">200MB</div>
        </div>
        <div @click="moneyClick(500)">
          <div class="size-title">500MB</div>
        </div>
        <div @click="moneyClick(1024)">
          <div class="size-title">1GB</div>
        </div>
        <div @click="moneyClick(4096)">
          <div class="size-title">4GB</div>
        </div>
        <div @click="moneyClick(20480)">
          <div class="size-title">20GB</div>
        </div>
      </div>
    </div>
