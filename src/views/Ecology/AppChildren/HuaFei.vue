<template>
  <div>
		<main-nav :title="$t('title.huafei')" fontColor="#fff" bgColor="#2C303E" :backShow="true" borderBottom="#252935"></main-nav>
    <div class="phone-div">
      ...
      <div class="phone-sizes">
        <div @click="moneyClick(10)">
          <div class="size-title">10元</div>
        </div>
        <div @click="moneyClick(20)">
          <div class="size-title">20元</div>
        </div>
        <div @click="moneyClick(30)">
          <div class="size-title">30元</div>
        </div>
        <div @click="moneyClick(50)">
          <div class="size-title">50元</div>
        </div>
        <div @click="moneyClick(100)">
          <div class="size-title">100元</div>
        </div>
        <div @click="moneyClick(300)">
          <div class="size-title">300元</div>
        </div>
      </div>
    </div>
